(function($){
	$.fn.floatAd = function(options){
		...
		var html = "<div id='float_ad' style='position:absolute;left:0px;top:0px;z-index:1000000;cleat:both;'>";
            html += " <img src='../../aaa/js/" + options.imgSrc + "' border='0' class='float_ad_img'/> <span href='javascript:;' id='close_float_ad' style=' color:#333;display:inline-block; line-height:16px; float:right; margin-top:182px; width:60px;text-align:center;cursor:pointer;position:relative; margin-left:-60px;'>点击关闭</span>";
            html += "</div>";
